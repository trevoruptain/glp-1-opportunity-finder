    ...
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Detailed analysis and research summary
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  {getPriorityLabel(disease.priorityScore)}
                </p>
              </div>
              <Badge className={getPriorityColor(disease.priorityScore)}>
                {disease.priorityScore}/100
              </Badge>
            </div>
          )}
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <p className="text-sm text-blue-800">
              Based on current literature, {disease.name.toLowerCase()} shows
              potential as a GLP-1 target indication due to metabolic pathway
              involvement and unmet medical need. Further research into
              mechanism of action and clinical feasibility is recommended.
            </p>
          </div>
        </div>
